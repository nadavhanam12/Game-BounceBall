...
public static class LeanTweenExt
{
    ...
    public static LTDescr MyLeanAlphaText(this TMP_Text textMesh, float to, float time)
    {
    ...
    public static LTDescr MyLeanAlphaImage(this RawImage image, float to, float time)
    {
